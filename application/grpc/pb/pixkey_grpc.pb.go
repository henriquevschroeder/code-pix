...
const (
	PixService_RegisterPixKey_FullMethodName = "/github.com.henriquevschroeder.codepix.PixService/RegisterPixKey"
	PixService_FindKey_FullMethodName        = "/github.com.henriquevschroeder.codepix.PixService/FindKey"
)
...
type PixServiceClient interface {
	...
	FindKey(ctx context.Context, in *PixKey, opts ...grpc.CallOption) (*PixKeyInfo, error)
}
...
func (c *pixServiceClient) FindKey(ctx context.Context, in *PixKey, opts ...grpc.CallOption) (*PixKeyInfo, error) {
	out := new(PixKeyInfo)
	err := c.cc.Invoke(ctx, PixService_FindKey_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PixServiceServer interface {
	...
	FindKey(context.Context, *PixKey) (*PixKeyInfo, error)
...
func (UnimplementedPixServiceServer) FindKey(context.Context, *PixKey) (*PixKeyInfo, error) {
...
func _PixService_FindKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PixServiceServer).FindKey(ctx, req.(*PixKey))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PixService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "github.com.henriquevschroeder.codepix.PixService",
